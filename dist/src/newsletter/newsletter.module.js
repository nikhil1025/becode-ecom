...
exports.NewsletterModule = NewsletterModule = __decorate([
    (0, common_1.Module)({
        providers: [newsletter_service_1.NewsletterService, prisma_service_1.PrismaService],
        controllers: [newsletter_controller_1.NewsletterController, newsletter_controller_1.NewsletterAdminController],
    })
], NewsletterModule);
