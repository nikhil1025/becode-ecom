...
exports.HomeModule = HomeModule = __decorate([
    (0, common_1.Module)({
        providers: [home_service_1.HomeService, prisma_service_1.PrismaService, audit_log_service_1.AuditLogService],
        controllers: [home_controller_1.HomeController, homepage_config_controller_1.HomepageConfigController, audit_log_controller_1.AuditLogController],
