...
exports.CommunityModule = CommunityModule = __decorate([
    (0, common_1.Module)({
        providers: [community_service_1.CommunityService, prisma_service_1.PrismaService],
        controllers: [community_controller_1.CommunityController, community_controller_1.CommunityAdminController],
    })
], CommunityModule);
