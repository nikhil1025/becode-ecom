...
exports.FeaturedProductsService = void 0;
const common_1 = require("@nestjs/common");
const prisma_service_1 = require("../prisma.service");
let FeaturedProductsService = class FeaturedProductsService {
    prisma;
    constructor(prisma) {
        this.prisma = prisma;
    }
    async create(dto) {
        ...
        if (existing)
            throw new common_1.ConflictException('Product is already featured');
    ...
    async reorder(items) {
        const updates = items.map((item) => this.prisma.featuredProduct.update({
            where: { id: item.id },
...
exports.FeaturedProductsService = FeaturedProductsService;
exports.FeaturedProductsService = FeaturedProductsService = __decorate([
    (0, common_1.Injectable)(),
    __metadata("design:paramtypes", [prisma_service_1.PrismaService])
], FeaturedProductsService);
//# sourceMappingURL=featured-products.service.js.map